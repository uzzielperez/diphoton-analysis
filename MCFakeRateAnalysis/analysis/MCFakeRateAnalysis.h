...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop(const Char_t *); // added by me
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/user/abuccill/DiPhotonAnalysis/MCFakeRateMerged/diphoton_fakeRate_GGJets_M-1000To2000_Pt-50_13TeV-sherpa_76X_MiniAOD_merged.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmsxrootd.fnal.gov//store/user/abuccill/DiPhotonAnalysis/MCFakeRateMerged/diphoton_fakeRate_GGJets_M-1000To2000_Pt-50_13TeV-sherpa_76X_MiniAOD_merged.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://cmsxrootd.fnal.gov//store/user/abuccill/DiPhotonAnalysis/MCFakeRateMerged/diphoton_fakeRate_GGJets_M-1000To2000_Pt-50_13TeV-sherpa_76X_MiniAOD_merged.root:/diphoton");
