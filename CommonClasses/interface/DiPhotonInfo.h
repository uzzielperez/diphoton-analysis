...
namespace ExoDiPhotons
{
  ...
  std::string diphotonBranchDefString("Minv/D:qt:deltaPhi:deltaEta:deltaR:deltaROld:cosThetaStar:cosThetaStarOld");
  ...
  void FillDiphotonInfo(diphotonInfo_t &fDiphotonInfo, const pat::Photon *photon1, const pat::Photon *photon2) {
    reco::LeafCandidate::LorentzVector photon_vector1 = photon1->p4();
    reco::LeafCandidate::LorentzVector photon_vector2 = photon2->p4();
