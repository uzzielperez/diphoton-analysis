...
static constexpr auto s_tag = "[ExoEfficiencyAnalyzer]";

TEST_CASE("Standard checks of ExoEfficiencyAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("ExoEfficiencyAnalyzer"
