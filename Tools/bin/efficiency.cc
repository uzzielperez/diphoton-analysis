...
void oneHist(const std::string& varname, TChain *ch, const std::string& year, bool isTF)
{
  ...
  if(year.find("2017") != std::string::npos || year.find("2018") != std::string::npos) {
    ...
    if(isTF) {
      ...
      numeratorCut = "isGood && (HLT_DoublePhoton70 || HLT_ECALHT800) && HLT_DoublePhoton33_CaloIdL && abs(Photon1.eta)<2.5 && abs(Photon2.eta)<2.5";
    }
  ...
  if(year.find("2017") != std::string::npos || year.find("2018") != std::string::npos) {
    ...
    if(isTF) {
      ...
      denominatorCut = "isGood && HLT_DoublePhoton33_CaloIdL && abs(TFPhoton1.eta)<2.5 && abs(TFPhoton2.eta)<2.5";
    }
