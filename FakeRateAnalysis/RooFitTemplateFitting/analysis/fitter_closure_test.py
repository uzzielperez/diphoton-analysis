...
infile = TFile("fakeRatePlots.root","read")

plotorigEB = infile.Get("fakeRateEB_chIso5To10")
plotEBclone = plotorigEB.Clone()
plotEB = TGraphAsymmErrorsToTH1D(plotEBclone,"plotEB")

plotorigEE = infile.Get("fakeRateEE_chIso5To10")
...
c.cd()
plotEB.Draw()
plotEB.GetYaxis().SetRangeUser(0.,0.15);
c.SaveAs("fitEB.pdf")

c.Clear()
plotEE.Draw()
plotEE.GetYaxis().SetRangeUser(0.,0.45);
c.SaveAs("fitEE.pdf")
