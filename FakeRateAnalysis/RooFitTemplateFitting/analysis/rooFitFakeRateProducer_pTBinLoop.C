...
std::pair<double,double> rooFitFakeRateProducer(TString ptBin, TString etaBin, std::pair<double,double> sideband, int denomBin)
{
  ...
  TFile *historealmcfile = TFile::Open("../../MCFakeRateAnalysis/analysis/diphoton_fakeRate_GGJets_M-200To500_Pt-50_13TeV-sherpa_76X_MiniAOD_histograms_matchedToLeadingJetDr0p6.root");
  // for data
  TFile *histojetfile = TFile::Open("../../DataFakeRateAnalysis/analysis/diphoton_fakeRate_JetHT_Run2015_16Dec2015-v1_MINIAOD_histograms_matchedToLeadingJetDr0p6.root");
  // for MC as data
