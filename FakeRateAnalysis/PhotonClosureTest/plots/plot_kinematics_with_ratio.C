...
// compare MC truth kinematics against denominator with and without fake rate applied
int plot_kinematics_sansdenom(TFile *f_all, TFile *f_fakes, TString name, TString era = "2016") {
  ...
  c->SaveAs("closure_test_photon_kinematics_"+name+"_"+era+"sans_Denom.pdf");
...
void plot_kinematics_with_ratio(TString sample =  "all", TString era= "2016") {
  ...
  plot_kinematics_sansdenom(f_closure_test,f_closure_test_matching,"eta",era);
  plot_kinematics_sansdenom(f_closure_test,f_closure_test_matching,"phi",era);
}
