...
// Sun Aug  2 16:46:03 2020 by ROOT version 6.12/07
// from TTree fTree/PhotonTree
// found on file: root://cmseos.fnal.gov//store/user/cawest/diphoton_closure/27a1c52/GGJets_M-8000To13000_Pt-50_13TeV-sherpa/crab_GGJets_M-8000To13000_Pt-50_13TeV-sherpa__RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1__MI/200730_151230/0000/out_GGJets_M-8000To13000_Pt-50_13TeV-sherpa_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_numEvent5000_1.root
//////////////////////////////////////////////////////////

#ifndef MCFakeRateClosureTest2_h
#define MCFakeRateClosureTest2_h
...
class MCFakeRateClosureTest2Base{
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MCFakeRateClosureTest2Base(TTree *tree=0);
   virtual ~MCFakeRateClosureTest2Base();
...
#ifdef MCFakeRateClosureTest2_cxx
MCFakeRateClosureTest2Base::MCFakeRateClosureTest2Base(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("root://cmseos.fnal.gov//store/user/cawest/diphoton_closure/27a1c52/GGJets_M-8000To13000_Pt-50_13TeV-sherpa/crab_GGJets_M-8000To13000_Pt-50_13TeV-sherpa__RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1__MI/200730_151230/0000/out_GGJets_M-8000To13000_Pt-50_13TeV-sherpa_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_numEvent5000_1.root:/diphoton");
...
MCFakeRateClosureTest2Base::~MCFakeRateClosureTest2Base()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCFakeRateClosureTest2Base::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCFakeRateClosureTest2Base::LoadTree(Long64_t entry)
{
...
void MCFakeRateClosureTest2Base::Init(TTree *tree)
{
...
Bool_t MCFakeRateClosureTest2Base::Notify()
{
...
void MCFakeRateClosureTest2Base::Show(Long64_t entry)
{
...
Int_t MCFakeRateClosureTest2Base::Cut(Long64_t entry)
{
...
double MCFakeRateClosureTest2Base::FakeRateEB(double pt) {
...
double MCFakeRateClosureTest2Base::FakeRateEE(double pt) {
...
#endif // #ifdef MCFakeRateClosureTest2_cxx
